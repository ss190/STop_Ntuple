...
#ifndef HFntupleNONE_h
#define HFntupleNONE_h
...
public :
   ...
   TH1F Ana_AllHad_2b_Thrust_Thrust[7];
   TH1F Ana_AllHad_2b_Thrust_Thrust_Met_dPhi[7];
   TH1F Ana_AllHad_2b_Thrust_Jet_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_Jet_PtThrust[7];
   TH2F Ana_AllHad_2b_Thrust_Jet_PThrust2D[7];
   TH1F Ana_AllHad_2b_Thrust_bJet_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_bJet_PtThrust[7];
   TH2F Ana_AllHad_2b_Thrust_bJet_PThrust2D[7];
   TH1F Ana_AllHad_2b_Thrust_ISRJet_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_ISRJet_PtThrust[7];
   TH2F Ana_AllHad_2b_Thrust_ISRJet_PThrust2D[7];

   TH1F Ana_AllHad_2b_Thrust_NJets_NegHemi[7];
   TH1F Ana_AllHad_2b_Thrust_NJets_PosHemi[7];

   TH1F Ana_AllHad_2b_Thrust_METISR_PtDirRatio[7];
   TH1F Ana_AllHad_2b_Thrust_n_TTjets[7];
   TH1F Ana_AllHad_2b_Thrust_n_bTTjets[7];

   TH1F Ana_AllHad_2b_Thrust_MaxJetBMass[7];
   TH1F Ana_AllHad_2b_Thrust_MinJetBMass[7];

   TH1F Ana_AllHad_2b_Thrust_nISRJets[7];

   TH1F Ana_AllHad_2b_Thrust_ISRMass[7];
   TH1F Ana_AllHad_2b_Thrust_TTMass[7];

   TH1F Ana_AllHad_2b_Thrust_ISR_Pt[7];
   TH1F Ana_AllHad_2b_Thrust_ISR_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_ISRMet_DPhi[7];
   TH1F Ana_AllHad_2b_Thrust_METoverISR_pt[7];
   TH1F Ana_AllHad_2b_Thrust_METoverISR_PThrust[7];

   TH1F Ana_AllHad_2b_Thrust_TT_Pt[7];
   TH1F Ana_AllHad_2b_Thrust_TT_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_TToverISR_pt[7];
   TH1F Ana_AllHad_2b_Thrust_TToverISR_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_METoverTT_pt[7];
   TH1F Ana_AllHad_2b_Thrust_METoverTT_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_ISRTT_DPhi[7];
   TH1F Ana_AllHad_2b_Thrust_TTMET_DPhi[7];

   TH2F Ana_AllHad_2b_Thrust_ISR_MET_pt[7];
   TH2F Ana_AllHad_2b_Thrust_MET_TT_pt[7];
   TH2F Ana_AllHad_2b_Thrust_ISR_TT_pt[7];
   TH2F Ana_AllHad_2b_Thrust_ISR_MET_pthrust[7];
   TH2F Ana_AllHad_2b_Thrust_MET_TT_pthrust[7];
   TH2F Ana_AllHad_2b_Thrust_ISR_TT_pthrust[7];

   TH1F Ana_AllHad_2b_Thrust_multISR_ISR_Pt[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_ISR_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_ISRMet_DPhi[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_METoverISR_pt[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_METoverISR_PThrust[7];

   TH1F Ana_AllHad_2b_Thrust_multISR_TT_Pt[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_TT_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_TToverISR_pt[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_TToverISR_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_METoverTT_pt[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_METoverTT_PThrust[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_ISRTT_DPhi[7];
   TH1F Ana_AllHad_2b_Thrust_multISR_TTMET_DPhi[7];

   TH2F Ana_AllHad_2b_Thrust_multISR_ISR_MET_pt[7];
   TH2F Ana_AllHad_2b_Thrust_multISR_MET_TT_pt[7];
   TH2F Ana_AllHad_2b_Thrust_multISR_ISR_TT_pt[7];
   TH2F Ana_AllHad_2b_Thrust_multISR_ISR_MET_pthrust[7];
   TH2F Ana_AllHad_2b_Thrust_multISR_MET_TT_pthrust[7];
   TH2F Ana_AllHad_2b_Thrust_multISR_ISR_TT_pthrust[7];

   TH1F Ana_AllHad_2b_Thrust_MET[7];
   TH1F Ana_AllHad_2b_Thrust_HT[7];
   TH1F Ana_AllHad_2b_Thrust_CT[7];
   TH1F Ana_AllHad_2b_Thrust_nJets[7];
   TH1F Ana_AllHad_2b_Thrust_nHighPtJets[7];
   TH1F Ana_AllHad_2b_Thrust_Jet1Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet1Eta[7];
   TH1F Ana_AllHad_2b_Thrust_Jet2Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet2Eta[7];
   TH1F Ana_AllHad_2b_Thrust_Jet3Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet3Eta[7];
   TH1F Ana_AllHad_2b_Thrust_Jet4Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet4Eta[7];
   TH1F Ana_AllHad_2b_Thrust_Jet5Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet5Eta[7];
   TH1F Ana_AllHad_2b_Thrust_Jet6Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet6Eta[7];
   TH1F Ana_AllHad_2b_Thrust_Jet7Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet7Eta[7];
   TH1F Ana_AllHad_2b_Thrust_Jet8Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet8Eta[7];
   TH1F Ana_AllHad_2b_Thrust_Jet9Pt[7];
   TH1F Ana_AllHad_2b_Thrust_Jet9Eta[7];
   TH1F Ana_AllHad_2b_Thrust_minB_Mt[7];

   TH1F Ana_AllHad_2b_Thrust_METsig[7];
   TH1F Ana_AllHad_2b_Thrust_MET_over_ISR[7];

   TH1F Ana_AllHad_2b_Thrust_bJet1Pt[7];
   TH1F Ana_AllHad_2b_Thrust_bJet1Eta[7];
   TH1F Ana_AllHad_2b_Thrust_bJet1_ijet[7];
   TH1F Ana_AllHad_2b_Thrust_bJet2Pt[7];
   TH1F Ana_AllHad_2b_Thrust_bJet2Eta[7];
   TH1F Ana_AllHad_2b_Thrust_bJet2_ijet[7];
   TH1F Ana_AllHad_2b_Thrust_bJet3Pt[7];
   TH1F Ana_AllHad_2b_Thrust_bJet3Eta[7];
   TH1F Ana_AllHad_2b_Thrust_bJet3_ijet[7];

   TH1F Ana_AllHad_2b_Thrust_T_MaxPThrust_WMinDeltaR_FoundTop[7];
   TH1F Ana_AllHad_2b_Thrust_T_MaxPThrust_WMinDeltaR_Mass[7];
   TH1F Ana_AllHad_2b_Thrust_T_MaxPThrust_WMinDeltaR_pthrust[7];
   TH1F Ana_AllHad_2b_Thrust_T_MaxPThrust_WMinDeltaR_top_met_deltaphi[7];
   TH1F Ana_AllHad_2b_Thrust_T_MaxPThrust_WMinDeltaR_top_thrust_deltaphi[7];
   TH1F Ana_AllHad_2b_Thrust_T_MaxPThrust_WMinDeltaR_DeltaR[7];
   TH2F Ana_AllHad_2b_Thrust_T_MaxPThrust_WMinDeltaR_pthrust_mass[7];
   TH2F Ana_AllHad_2b_Thrust_T_MaxPThrust_WMinDeltaR_delta_pthrust_mass[7];

   TH1F Ana_AllHad_2b_Thrust_TruthTopID[7];
   ...
   HFntupleNONE(TTree *tree=0);
   virtual ~HFntupleNONE();
...
#ifdef HFntupleNONE_cxx
HFntupleNONE::HFntupleNONE(TTree *tree) : fChain(0) 
{
...
HFntupleNONE::~HFntupleNONE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HFntupleNONE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HFntupleNONE::LoadTree(Long64_t entry)
{
...
void HFntupleNONE::Init(TTree *tree)
{
...
void HFntupleNONE::Show(Long64_t entry)
{
...
Int_t HFntupleNONE::Cut(Long64_t entry)
{
